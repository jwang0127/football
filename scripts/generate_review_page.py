...
def main() -> None:
    ...
    review_day = datetime.strptime(args.date, "%Y%m%d")
    label = review_day.strftime("%m-%d")
    next_day = (review_day + timedelta(days=1)).strftime("%Y%m%d")
